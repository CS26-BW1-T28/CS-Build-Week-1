...
# build_chambers(width, height, total_chambers):
mars.build_chambers(level=level_length, size_x=grid_size, size_y=grid_size, listings=all_levels)
mars.jsonify()
