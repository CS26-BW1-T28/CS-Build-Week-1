...
class ChambersAttr:
    def __init__(self):
        ...
        self.chamber_desc = [
            {"title": "Outside", "desc": "Seas of red hills and rocks."},
            ...
            {"title": "Crystal Cave", "desc": "The crystals glow and hum."},
            {"title": "Hell", "desc": "There's no walls or ceiling. A hot wind blows."},
        ] 
        ...
        # every 60 chambers, insert one of these.
